...
const ownerNumber = [`919633687665@s.whatsapp.net`,`${owner}@s.whatsapp.net`]
...
const num = "919633687665@s.whatsapp.net"
...
const katalog = (teks) => {
             res = LexxyOFC.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "*_© KRIZ SER OFC_*", "thumbnail": img2, "surface": 'CATALOG' }}, {quoted:ftrol})
...
status: 1,
surface : 1,
message: `©By K R I Z   S E R`, 
orderTitle: `©By K R I Z   S E R`,
thumbnail: img2,
...
LexxyOFC.sendMessage(from, anu, image, {quoted: flexx, caption: 'Quotes By KRIZ SER OFC' })
break
case 'faktaunik':
reply(mess.wait)
            ...
            var ctlg = await LexxyOFC.prepareMessageFromContent(from, {
                "productMessage": {
                    "product": {
                        ...
                        "footerText": `メKRIZ SER OFC̵`,
                        "currencyCode": "IDR",
                        "priceAmount1000": "100000000",
                        "productImageCount": 1,
                        "firstImageId": 1,
                        "salePriceAmount1000": "35000000",
                        "retailerId": `YouTube : KRIZ SER OFC×`,
                        "url": "OWNER : https://wa.me/919633687665\nYT : https://bit.ly/3BpBe1Z\nGROUP : https://bit.ly/3Ene2TO"
                    },
                    "businessOwnerJid": "919633687665@s.whatsapp.net",
                }
...
LexxyOFC.sendMessage(from, hasil, image, { thumbnail: Buffer.alloc(0), caption: `DONE NIH JANGAN LUPA Subscribe KRIZ SER OFC`, quoted : flexx })
})
break
case 'nulis':
if (args.length == 0) return reply(`Text Nya Mana\nContoh: ${prefix + command} KRIZ SER OFC`)
bo = args.join(" ")
reply(mess.wait)
...
┗━━━━━━━━━━━━━
━➤ 「 𝙄𝙉𝙁𝙊 𝘿𝙀𝙑 」
✍️ 𝑆𝑐𝑟𝑖𝑝𝑡 𝑀𝑎𝑑𝑒 𝑖𝑛 𝐵𝑦 kriz 𝑂𝑓𝑓𝑖𝑐𝑖𝑎𝑙
🌟 𝑉𝑒𝑟𝑠𝑖𝑜𝑛 : 6.0
📈 𝐿𝑎𝑠𝑡 𝑈𝑝𝑑𝑎𝑡𝑒 : 14-𝐷𝑒𝑠-2021

📦 𝐺𝑟𝑢𝑝:
https://chat.whatsapp.com/LeGxfgT6gjV0sAOkYC5fG

🌐 𝑌𝑜𝑢𝑇𝑢𝑏𝑒:
https://youtube.com/c/LE4YOUU
